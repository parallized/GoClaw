...
export default defineConfig({
  ...
  shortcuts: [
    ...
    [
      "n-glass-card",
      "bg-surface backdrop-blur-[24px] saturate-180 border border-edge rounded-3xl transition-all duration-500 shadow-sm hover:border-accent-indigo/50 hover:shadow-md",
    ],
    // Form inputs
    [
      "n-input",
